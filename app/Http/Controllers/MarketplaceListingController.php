            ...
            return [
                ...
                'bids' => $listing->bids->map(function ($bid) use ($request, $user) {
                    ...
                    return [
                        ...
                        'bidderAvatar' => $bidUser ? $bidUser->avatar_url : 'https://ui-avatars.com/api/?name=Student&background=random',
    ...
    public function getBids(Request $request, string $id): JsonResponse
    {
        ...
        $formatted = $bids->map(function ($bid) use ($request, $listing) {
            ...
            return [
                ...
                'bidderAvatar' => $user ? $user->avatar_url : 'https://ui-avatars.com/api/?name=Student&background=random',
